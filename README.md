...
- Related-topic edges are sparse, undirected links without a parent/child hierarchy. They ignore standalone calendar dates, clock values, and split date parts, while named identifiers containing letters, such as `BW2026`, remain available as evidence.

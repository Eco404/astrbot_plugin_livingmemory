...
- Related-subtopic evidence ignores standalone calendar dates, clock values, and split date parts. Named identifiers containing letters, such as `BW2026`, remain available as evidence.

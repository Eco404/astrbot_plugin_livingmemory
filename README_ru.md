...
**Версия**: v2.1.9 | **Автор**: lxfight | **Лицензия**: AGPLv3
...
- **Управление через WebUI**: Визуальный интерфейс управления памятью
...
├── storage/                         # Слой хранения (DBMigration, ConversationStore)
...
- [API-документация](docs/API.md): Подробный API-справочник
- [Документация по архитектуре](docs/ARCHITECTURE.md): Описание системной архитектуры
- [Руководство разработчика](docs/DEVELOPMENT.md): Руководство по разработке и внесению вклада

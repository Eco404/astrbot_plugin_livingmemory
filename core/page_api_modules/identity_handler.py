"""Supplemental identity profile management for the plugin dashboard."""
...
from ..models.identity_profile import parse_supplemental_identity_profiles
...
class IdentityHandler:
    ...
    async def save_profiles(
        ...
        *,
        ...
        try:
            parsed_profiles = parse_supplemental_identity_profiles(profiles)
            ...
            result["applies_to"] = "future_generation_or_rebuild"
            ...
            logger.warning("[PageAPI] 保存补充人物资料失败: %s", exc)

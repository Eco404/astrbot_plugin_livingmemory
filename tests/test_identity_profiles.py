...
def test_supplemental_profile_matches_only_stable_actor_identity() -> None:
    ...
    assert profile.matches_actor_id("qq:human:10000001") is True
    assert profile.matches_actor_id("aiocqhttp:human:10000001") is True
    assert profile.matches_actor_id("qq:human:different-account") is False
    assert profile.matches_actor_id("unresolved:fragment:示例甲") is False

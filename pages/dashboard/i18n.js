...
(() => {
  ...
  const MSG = {
    ...
    "maintenance.timelineRebuildTab": { zh: "Timeline 重构", en: "Timeline rebuild", ru: "Пересборка Timeline" },
    "maintenance.timelineRebuildTitle": { zh: "Timeline 来源重构", en: "Source-verified Timeline rebuild", ru: "Пересборка Timeline по источникам" },
    ...
    "maintenance.rebuildTasks": { zh: "Timeline 重构任务", en: "Timeline rebuild tasks", ru: "Задачи пересборки Timeline" },
    ...
    "maintenance.rebuildStarted": { zh: "Timeline 重构任务已开始", en: "Timeline rebuild started", ru: "Пересборка Timeline запущена" },
    "maintenance.failedCount": { zh: "失败 {0}", en: "{0} failed", ru: "Ошибок: {0}" },
    "maintenance.resumeTask": { zh: "重试", en: "Retry", ru: "Повторить" },
    "maintenance.clearRebuildTasks": { zh: "清空 Timeline 重构历史", en: "Clear Timeline rebuild history", ru: "Очистить историю пересборки" },

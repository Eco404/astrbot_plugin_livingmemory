...
(() => {
  ...
  const MSG = {
    ...
    "maintenance.reviewIntro": { zh: "核对歧义片段与候选 Topic，再决定合并、新建、暂缓或忽略。", en: "Inspect ambiguous fragments and candidates before merging, creating, deferring, or ignoring them.", ru: "Проверьте неоднозначные фрагменты и кандидаты." },
    "maintenance.governance": { zh: "合并 / 拆分", en: "Merge / split", ru: "Объединить / разделить" },
    ...
    "maintenance.defer": { zh: "暂缓", en: "Defer", ru: "Отложить" },
    ...
    "maintenance.identityPending": { zh: "有 {0} 个 Topic 等待人物资料同步重建", en: "{0} Topics are waiting for identity sync", ru: "Topic ожидают синхронизации: {0}" },
    ...
    "maintenance.cleanupSummarized": { zh: "清理已总结的旧消息", en: "Clean summarized old messages", ru: "Очистить обобщённые сообщения" },
    "maintenance.deleteRawKeepMemory": { zh: "删除原始会话，保留 Timeline/Topic", en: "Delete raw session, keep Timeline/Topic", ru: "Удалить исходный сеанс, сохранить память" },
    "maintenance.mergeAliases": { zh: "合并会话别名", en: "Merge session aliases", ru: "Объединить псевдонимы" },
    "maintenance.deleteMemoryChain": { zh: "完整删除会话记忆链", en: "Delete the full session memory chain", ru: "Удалить всю цепочку памяти" },
    ...
    "maintenance.operation.cleanup_summarized": { zh: "清理已总结消息", en: "Clean summarized messages", ru: "Очистка сообщений" },
    "maintenance.operation.delete_raw_keep_memory": { zh: "删除原始会话", en: "Delete raw session", ru: "Удаление исходного сеанса" },
    "maintenance.operation.merge_aliases": { zh: "合并会话别名", en: "Merge aliases", ru: "Объединение псевдонимов" },
    "maintenance.operation.delete_memory_chain": { zh: "完整删除记忆链", en: "Delete memory chain", ru: "Удаление цепочки памяти" },
    ...
    "identity.displayNamePh": { zh: "例如 示例甲", en: "e.g. 示例甲", ru: "например 示例甲" },
    ...
    "identity.syncNow": { zh: "立即同步重建", en: "Sync rebuild now", ru: "Пересобрать сейчас" },
    "identity.savedQueued": { zh: "人物资料已保存；已将 {1} 条 Timeline（{0} 个空间）加入 Topic 自动维护队列", en: "Profiles saved; queued {1} Timeline memories in {0} spaces for Topic maintenance", ru: "Профили сохранены; {1} Timeline в {0} пространствах добавлены в очередь" },
    "identity.savedPending": { zh: "人物资料已保存；{0} 条 Timeline 等待同步。自动维护已关闭，可点击“立即同步重建”", en: "Profiles saved; {0} Timeline memories await sync. Auto maintenance is off; use Sync rebuild now", ru: "Профили сохранены; {0} Timeline ожидают синхронизации" },
    "identity.savedSyncFailed": { zh: "人物资料已保存，但 Topic 同步排队失败：{0}", en: "Profiles saved, but Topic sync could not be queued: {0}", ru: "Профили сохранены, но синхронизация Topic не поставлена в очередь: {0}" },
    "identity.syncQueued": { zh: "已立即调度 {1} 条 Timeline（{0} 个空间）的 Topic 同步重建", en: "Immediately scheduled Topic rebuild for {1} Timeline memories in {0} spaces", ru: "Немедленно запланирована пересборка {1} Timeline в {0} пространствах" },
    "identity.syncNone": { zh: "没有等待人物资料同步的 Topic", en: "No Topics are waiting for identity sync", ru: "Нет Topic, ожидающих синхронизации личности" },
    "identity.syncFailed": { zh: "Topic 人物资料同步失败", en: "Topic identity sync failed", ru: "Не удалось синхронизировать личности Topic" },
    ...
    "identity.deleteImpactTitle": { zh: "删除人物资料影响", en: "Identity deletion impact", ru: "Последствия удаления профиля" },
    "identity.deleteImpactWarning": { zh: "删除人物资料不会删除 Timeline 或 Topic 正文，但相关 Topic 的人物解析需要同步重建。请核对影响范围。", en: "Deleting a profile does not delete Timeline or Topic content, but affected actor indexes must be rebuilt. Review the impact first.", ru: "Удаление профиля не удаляет память, но требует пересборки индекса." },
    "identity.deletedProfiles": { zh: "删除人物", en: "Deleted profiles", ru: "Удаляемые профили" },
    "identity.affectedTopics": { zh: "受影响的 Topic", en: "Affected Topics", ru: "Затронутые Topic" },
    "identity.syncChoice": { zh: "保存后的同步方式", en: "Post-save sync", ru: "Синхронизация после сохранения" },
    "identity.syncQueue": { zh: "加入自动维护队列", en: "Queue for maintenance", ru: "Добавить в очередь" },
    "identity.syncQueueHelp": { zh: "保留当前 Topic，等待自动维护；自动维护关闭时会持续显示待同步状态。", en: "Keep current Topics until maintenance runs; when auto maintenance is off, the pending state remains visible.", ru: "Сохранить текущие Topic до обслуживания." },
    "identity.syncImmediate": { zh: "立即同步重建", en: "Rebuild immediately", ru: "Пересобрать сейчас" },
    "identity.syncImmediateHelp": { zh: "保存后立即调度受影响 Timeline 的局部 Topic 重建。", en: "Immediately schedule a focused rebuild for affected Timelines.", ru: "Немедленно запустить локальную пересборку." },
    "identity.confirmDeleteSave": { zh: "确认删除并保存", en: "Delete and save", ru: "Удалить и сохранить" },
    ...
    "topic.resolution.profile_inferred": { zh: "权威资料推断", en: "Profile-inferred", ru: "Определено по профилю" },
    ...
    "topic.identifierDetails": { zh: "标识符与溯源", en: "Identifiers and provenance", ru: "Идентификаторы и происхождение" },

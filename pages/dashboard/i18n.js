...
(() => {
  ...
  const MSG = {
    ...
    "topic.stageFailure.materialization": { zh: "将 Topic、原子、片段和来源索引写入数据库时出错；当前 Topic 快照使用事务保护。", en: "The build failed while writing Topics, atoms, fragments, and provenance indexes to the database.", ru: "Ошибка при записи Topic, атомов, фрагментов и индексов происхождения." },
